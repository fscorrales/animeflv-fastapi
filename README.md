...
Inside the `handlers` folder, you can execute the scripts that have been created using `argparse`. To run a script, simply use the following command:

```bash
python -m src.api.handlers.script_name
```

Replace script_name with the actual name of the script you want to run. These scripts allow you to interact with different functionalities of the API directly from the command line. There is a full example at:
